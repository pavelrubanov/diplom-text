...
\filltitle{ru}{
    ...
    %% Актуально всем.
    title              = {Разработка системы для сегментации, контурирования и параметрического анализа биологических объектов},
    %
    ...
    kind               = {solution},
    %
    author             = {РУБАНОВ Павел Евгеньевич},
    %
    ...
    supervisorPosition = {зав. кафедры информационно-аналитических систем, к.ф-м.н.},
    supervisor         = {Михайлова~Е.~Г.},
    %
    %% Актуально только для ВКР.
    reviewerPosition = {аналитик, группа аудиометрийных исследований, АО «Медиаскоп»},
    reviewer         = {Мамаева~А.~С.},
    %
    ...
    consultantPosition   = {м.н.с. лаборатории Гербарий, ФГБУН \enquote{ГБС РАН},},
    consultant           = {Шкурко~А.~В.},
}
...
\filltitle{en}{
    chair              = {Chair of Analytical Information Systems},
    group              = {22.B07-mm},
    %
    title              = {Development of a system for segmentation, contouring, and parametric analysis of biological objects},
    %
    type               = {bachelor},
    %
    kind               = {solution},
    %
    author             = {Pavel Rubanov},
    %
    ...
    %
    supervisorPosition = {head of the chair of Analytical Information Systems, C.Sc.},
    supervisor         = {E.\,G.~Mikhailova},
    %
    reviewerPosition   = {analyst, audience measurement research group, \foreignquote{english}{Mediascope} JSC},
    reviewer           = {A.\,S.~Mamaeva},
    %
    consultantPosition = {junior researcher, Herbarium laboratory, FSBSI \foreignquote{english}{MBG RAS},},
    consultant         = {A.\,V.~Shkurko},
}
